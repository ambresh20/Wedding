      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 flex justify-between">
          <div className="my-8">
            ...
            <p className="text-gray-400 max-w-xl mx-auto mt-12 text-start">
              Crafting unforgettable moments and turning your special day into a
              beautiful story to remember.
            </p>
          </div>
        ...
        <section className="bg-[#161E29] py-10 mb-8">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-white text-3xl font-bold mb-6">TESTIMONIALS</h2>
          ...
          <div className="min-h-screen px-4">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-slate-300 text-center max-w-3xl mx-auto mb-16 space-y-4">
                <p>
                  cursus volutpat varius id libero, faucibus non, placerat nisl,
                  sollicitudin dui Vestibulum vel Sed amet, nec elit at quis id
                  lacus nec gravida elit quis dolor Vestibulum commodo cursus ex
                  viverra vitae In convallis.
                </p>
                <p>
                  ultrices lacus, nec facilisis risus dui ipsum sit In tincidunt
                  tincidunt urna facilisis Donec amet, ex orci Praesent
                  dignissim, lacus ac non, efficitur. Ut et Ut viverra
                  scelerisque Nullam id dui, non, nec nisi. non, Ut vitae
                  lobortis,
                </p>
              </div>
